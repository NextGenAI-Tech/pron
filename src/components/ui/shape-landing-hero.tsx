      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center md:max-w-5xl">
          ...
          >
            <Text
              as="h1"
              className="mb-6 text-center text-xl font-bold tracking-tight sm:text-2xl md:mb-10 md:text-4xl lg:text-7xl"
            >
              <span className="bg-gradient-to-b from-white to-white/80 bg-clip-text whitespace-pre-line text-transparent">
                {title1}
              </span>
              <br />
              <span
          ...
          >
            <form action={handleStart}>
              <Button size="lg" className="w-xs cursor-pointer">
                <Text className="font-bold">시작하기</Text>
              </Button>
            </form>
          </motion.div>
        </div>
